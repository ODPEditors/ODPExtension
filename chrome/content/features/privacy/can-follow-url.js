(function()
{
	...
	this.canFollowURL = function(aURL, focusedURL)
	{
		...
		if(!focusedURL){}
			...
			if(false
			   || focusedURL.indexOf('.domaintools.com') != -1 && aURL.indexOf('.domaintools.com') != -1
			   || focusedURL.indexOf('.google.') != -1 && ( aURL.indexOf('.google.') != -1 || aURL.indexOf('cache:') != -1  || aURL.indexOf('related:') != -1  || aURL.indexOf('site:') != -1 )
			   || focusedURL.indexOf('.yahoo.') != -1 && aURL.indexOf('.yahoo.') != -1
			   || focusedURL.indexOf('.bing.') != -1 && aURL.indexOf('.bing.') != -1
			)
				return false;
		}
