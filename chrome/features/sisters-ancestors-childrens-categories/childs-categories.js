(function() {
		...
		this.addListener('userInterfaceLoad', function() {
			ODPExtension.childCategoriesOnUserInterfaceLoad()
		});
		this.addListener('userInterfaceUpdate', function(aEnabled) {
			ODPExtension.childCategoriesOnUserInterfaceUpdate(aEnabled);
		});
		...
		this.childCategoriesOnUserInterfaceLoad = function() {
			this.dump('childCategoriesOnUserInterfaceLoad', debugingThisFile);

			aButton = this.getElement('toolbarbutton-childs-categories');
		}
		...
		this.childCategoriesOnUserInterfaceUpdate = function(aEnabled) {
			this.dump('childCategoriesOnUserInterfaceUpdate', debugingThisFile);
