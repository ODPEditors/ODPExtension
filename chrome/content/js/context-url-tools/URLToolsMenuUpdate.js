					...
					for(var id in urls)
					{
						if(urls[id].indexOf('--') === 0)
						{
							...
							var add = this.create("menuitem");
								...
								add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/open-all.png");
						...
						//adding a pretty icon
							//moz
								if(urls[id].indexOf('tubert.org') != -1)
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/tubert.png");
								else if(urls[id].indexOf('rpfuller.com') != -1 || urls[id].indexOf('rpfuller.org') != -1)
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/rp.png");
								else if(urls[id].indexOf('pmoz.info') != -1)
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/pmoz.png");
								...
								else if(urls[id].indexOf('godzuki.info') != -1)
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/extension-icon/listed-domain-uri.png");
							//commands
							...
							//tools
									...
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/domaintools.png");
								else if(urls[id].indexOf('w3.') != -1)
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/w3c.ico");
							//archive
								else if(urls[id].indexOf('archive.org') != -1)
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/archive.ico");
							//search engines
							...
							//blank
									...
									add.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/blank.png");
						...
						if(domainTools[domain].length >= 3)
						{
							...
							//adding a pretty icon
								if(domain.indexOf('tubert.org') != -1)
									menuDomain.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/tubert.png");
								else if(domain.indexOf('rpfuller.com') != -1 || domain.indexOf('rpfuller.org') != -1)
									menuDomain.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/rp.png");
								else if(domain.indexOf('pmoz.info') != -1)
									menuDomain.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/pmoz.png");
									...
									menuDomain.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/spider.png");
							//adding the items
