					...
					for(var id in notes)
					{
						if(notes[id] != '')
						{
							...
							var menuitem = this.create('menuitem');
								...
								menuitem.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/toolbars-and-toolbarbuttons/word.png");
				...
				/*	for(var id in cache)
					{
						var menu = this.create('menu');
							...
							menu.setAttribute("image", "chrome://ODPExtension/content/xul/navigator/url-tools/open-all.png");
