		...
		//holds in memory data that is shared by all the windows of this browser instance.
			...
			this.preferencesLoadGlobal = function()
			{
				...
				//performance boost for preferences
					...
					this.shared.category.abbreviation.user = {};
					this.shared.category.abbreviation.user.find = this.trim(this.preferenceGet('category.abbreviation.find')).split('\n');
					this.shared.category.abbreviation.user.replace = this.trim(this.preferenceGet('category.abbreviation.replace')).split('\n');
